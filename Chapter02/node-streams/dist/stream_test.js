...
const filter_stream_1 = require("./filter_stream");
//we create object of our custom transformation & pass phone and email as sensitive properties
let filter = new filter_stream_1.FilterTransform(["phone", "email"]);
...
filter.write({
    name: "Parth",
    phone: "xxxxx-xxxxx",
    email: "ghiya.parth@gmail.com",
    id: 1,
});
filter.write({
    name: "Dhruvil",
    phone: "xxxxx-xxxxx",
    email: "dhruvil.thaker@gmail.com",
    id: 2,
});
filter.write({
    name: "Dhaval",
    phone: "xxxxx-xxxxx",
    email: "dhaval.marthak@gmail.com",
    id: 3,
});
filter.write({
    name: "Shruti",
